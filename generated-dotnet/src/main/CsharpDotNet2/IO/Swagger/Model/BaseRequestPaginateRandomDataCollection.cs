...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class BaseRequestPaginateRandomDataCollection {
    /// <summary>
    ...
    public PaginateRandomDataCollection Data { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class BaseRequestPaginateRandomDataCollection {\n");
